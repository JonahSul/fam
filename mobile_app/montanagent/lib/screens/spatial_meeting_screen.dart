...
class SpatialMeetingScreen extends StatefulWidget {
  final Function(SpaceBackgroundState) onStateChange;

  const SpatialMeetingScreen({
    super.key,
    required this.onStateChange,
  });

  @override
  State<SpatialMeetingScreen> createState() => _SpatialMeetingScreenState();
}

class _SpatialMeetingScreenState extends State<SpatialMeetingScreen>
