...
class SpatialSessionScreen extends StatefulWidget {
  final Function(SpaceBackgroundState) onStateChange;

  const SpatialSessionScreen({
    super.key,
    required this.onStateChange,
  });

  @override
  State<SpatialSessionScreen> createState() => _SpatialSessionScreenState();
}

class _SpatialSessionScreenState extends State<SpatialSessionScreen>
